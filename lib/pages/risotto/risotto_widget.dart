...
import 'risotto_model.dart';
export 'risotto_model.dart';

class RisottoWidget extends StatefulWidget {
  const RisottoWidget({super.key});

  @override
  _RisottoWidgetState createState() => _RisottoWidgetState();
}

class _RisottoWidgetState extends State<RisottoWidget> {
  late RisottoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RisottoModel());
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            16.0, 4.0, 16.0, 0.0),
                        child: Text(
                          'Delicioso Risotto preparado con recetas originales italianas, puede elegir acompañamientos para este magnifico plato.',
