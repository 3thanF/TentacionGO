...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Informacion_Para_Reservaciones_De_Mesas',
          path: '/informacionParaReservacionesDeMesas',
          builder: (context, params) =>
              const InformacionParaReservacionesDeMesasWidget(),
        ),
        FFRoute(
          name: 'Informacion_Pago_Mesas',
          path: '/informacionPagoMesas',
